...
333 continue
   ...
   call save_day_post_Lbol_max(6d0,t0,zone,star_mass,mass_IB,'006')
   call save_day_post_Lbol_max(7d0,t0,zone,star_mass,mass_IB,'007')
   call save_day_post_Lbol_max(8d0,t0,zone,star_mass,mass_IB,'008')
   call save_day_post_Lbol_max(9d0,t0,zone,star_mass,mass_IB,'009')
